public class class217 extends class180 {
   ...
   public class325 method4036(boolean bool_1, int i_2) {
      field2562 = false;
      int i_3;
      if (bool_1) {
         i_3 = this.field2600;
      ...
      if (i_3 == -1) {
         ...
         if (class325_6 != null) {
            ...
            if (class325_6 == null) {
               ...
               if (this.field2605) {
                  class325_6.method6128();
               }

               if (this.field2606) {
                  class325_6.method6117();
               }

               if (this.field2559 > 0) {
                  class325_6.method6115(this.field2559);
               }

               if (this.field2559 >= 1) {
                  class325_6.method6133(1);
               }

               if (this.field2559 >= 2) {
                  class325_6.method6133(16777215);
               }
   ...
   void method4031(class300 class300_1, byte b_2) {
      ...
      this.field2566 = class300_1.method5504((byte) 70);
      this.field2567 = class300_1.method5504((byte) 63);
      this.field2568 = class300_1.method5496(-1459053594);
      this.field2651 = class300_1.method5606(-1327508233);
      this.field2574 = class300_1.method5606(-1327508233);
      this.field2670 = class300_1.method5496(-1459053594);
      this.field2576 = class300_1.method5496(-1459053594);
      this.field2595 = class300_1.method5504((byte) 50);
      ...
      this.field2685 = class300_1.method5496(-1459053594);
      ...
      if (i_3 > 0) {
         ...
         for (i_4 = 0; i_4 < i_3; i_4++) {
            this.field2683[i_4] = class300_1.method5504((byte) 119);
            this.field2684[i_4] = class300_1.method5496(-1459053594);
         }
      }

      i_4 = class300_1.method5504((byte) 108);
      int i_5;
      int i_6;
      int i_7;
      if (i_4 > 0) {
         ...
         for (i_5 = 0; i_5 < i_4; i_5++) {
            i_6 = class300_1.method5496(-1459053594);
            this.field2682[i_5] = new int[i_6];

            for (i_7 = 0; i_7 < i_6; i_7++) {
               this.field2682[i_5][i_7] = class300_1.method5496(-1459053594);
      ...
      if (this.field2566 == 0) {
         this.field2569 = class300_1.method5496(-1459053594);
         this.field2706 = class300_1.method5504((byte) 101) == 1;
      }

      if (this.field2566 == 1) {
         class300_1.method5496(-1459053594);
         class300_1.method5504((byte) 107);
      }

      if (this.field2566 == 2) {
         this.field2560 = new int[this.field2576 * this.field2670];
         this.field2705 = new int[this.field2576 * this.field2670];
         i_5 = class300_1.method5504((byte) 84);
         if (i_5 == 1) {
            this.field2669 |= 0x10000000;
         }

         i_6 = class300_1.method5504((byte) 113);
         if (i_6 == 1) {
            this.field2669 |= 0x40000000;
         }

         i_7 = class300_1.method5504((byte) 54);
         if (i_7 == 1) {
            this.field2669 |= ~0x7fffffff;
         }

         int i_8 = class300_1.method5504((byte) 107);
         if (i_8 == 1) {
            this.field2669 |= 0x20000000;
         }

         this.field2631 = class300_1.method5504((byte) 76);
         this.field2632 = class300_1.method5504((byte) 38);
         ...
         for (i_9 = 0; i_9 < 20; i_9++) {
            int i_10 = class300_1.method5504((byte) 44);
            if (i_10 == 1) {
               this.field2633[i_9] = class300_1.method5606(-1327508233);
               this.field2634[i_9] = class300_1.method5606(-1327508233);
               this.field2635[i_9] = class300_1.method5499((byte) -96);
            } else {
               this.field2635[i_9] = -1;
            }
         }

         this.field2680 = new String[5];

         for (i_9 = 0; i_9 < 5; i_9++) {
            String string_12 = class300_1.method5503(-231155257);
            if (string_12.length() > 0) {
               this.field2680[i_9] = string_12;
               this.field2669 |= 1 << i_9 + 23;
            }
         }
      }

      if (this.field2566 == 3) {
         this.field2571 = class300_1.method5504((byte) 82) == 1;
      }

      if (this.field2566 == 4 || this.field2566 == 1) {
         this.field2628 = class300_1.method5504((byte) 51);
         this.field2629 = class300_1.method5504((byte) 51);
         this.field2627 = class300_1.method5504((byte) 9);
         this.field2624 = class300_1.method5496(-1459053594);
         if (this.field2624 == 65535) {
            this.field2624 = -1;
         }

         this.field2659 = class300_1.method5504((byte) 109) == 1;
      }

      if (this.field2566 == 4) {
         this.field2601 = class300_1.method5503(-231155257);
         this.field2590 = class300_1.method5503(-231155257);
      }

      if (this.field2566 == 1 || this.field2566 == 3 || this.field2566 == 4) {
         this.field2695 = class300_1.method5499((byte) -78);
      }

      if (this.field2566 == 3 || this.field2566 == 4) {
         this.field2639 = class300_1.method5499((byte) -106);
         this.field2587 = class300_1.method5499((byte) -28);
         this.field2663 = class300_1.method5499((byte) -102);
      }

      if (this.field2566 == 5) {
         this.field2599 = class300_1.method5499((byte) -118);
         this.field2600 = class300_1.method5499((byte) -12);
      }

      if (this.field2566 == 6) {
         this.field2607 = 1;
         this.field2649 = class300_1.method5496(-1459053594);
         if (this.field2649 == 65535) {
            this.field2649 = -1;
         }

         this.field2609 = 1;
         this.field2610 = class300_1.method5496(-1459053594);
         if (this.field2610 == 65535) {
            this.field2610 = -1;
         }

         this.field2611 = class300_1.method5496(-1459053594);
         if (this.field2611 == 65535) {
            this.field2611 = -1;
         }

         this.field2612 = class300_1.method5496(-1459053594);
         if (this.field2612 == 65535) {
            this.field2612 = -1;
         }

         this.field2618 = class300_1.method5496(-1459053594);
         this.field2615 = class300_1.method5496(-1459053594);
         this.field2616 = class300_1.method5496(-1459053594);
      }

      if (this.field2566 == 7) {
         this.field2560 = new int[this.field2670 * this.field2576];
         this.field2705 = new int[this.field2576 * this.field2670];
         this.field2628 = class300_1.method5504((byte) 15);
         this.field2624 = class300_1.method5496(-1459053594);
         if (this.field2624 == 65535) {
            this.field2624 = -1;
         }

         this.field2659 = class300_1.method5504((byte) 17) == 1;
         this.field2695 = class300_1.method5499((byte) -64);
         this.field2631 = class300_1.method5606(-1327508233);
         this.field2632 = class300_1.method5606(-1327508233);
         i_5 = class300_1.method5504((byte) 22);
         if (i_5 == 1) {
            this.field2669 |= 0x40000000;
         }
         ...
         for (i_6 = 0; i_6 < 5; i_6++) {
            String string_11 = class300_1.method5503(-231155257);
            if (string_11.length() > 0) {
               this.field2680[i_6] = string_11;
               this.field2669 |= 1 << i_6 + 23;
            }
         }
      }
      ...
      if (this.field2567 == 2 || this.field2566 == 2) {
         this.field2657 = class300_1.method5503(-231155257);
         this.field2686 = class300_1.method5503(-231155257);
         i_5 = class300_1.method5496(-1459053594) & 0x3f;
         this.field2669 |= i_5 << 11;
      }

      if (this.field2567 == 1 || this.field2567 == 4 || this.field2567 == 5 || this.field2567 == 6) {
         this.field2573 = class300_1.method5503(-231155257);
         if (this.field2573.length() == 0) {
            if (this.field2567 == 1) {
               this.field2573 = "Ok";
            }

            if (this.field2567 == 4) {
               this.field2573 = "Select";
            }
            ...
            if (this.field2567 == 6) {
               this.field2573 = "Continue";
            }
         }
      }

      if (this.field2567 == 1 || this.field2567 == 4 || this.field2567 == 5) {
         this.field2669 |= 0x400000;
      }
   ...
   void method4088(class300 class300_1, byte b_2) {
      class300_1.method5504((byte) 127);
      this.field2563 = true;
      this.field2566 = class300_1.method5504((byte) 49);
      this.field2568 = class300_1.method5496(-1459053594);
      this.field2651 = class300_1.method5606(-1327508233);
      this.field2574 = class300_1.method5606(-1327508233);
      this.field2670 = class300_1.method5496(-1459053594);
      if (this.field2566 == 9) {
         this.field2576 = class300_1.method5606(-1327508233);
      } else {
         this.field2576 = class300_1.method5496(-1459053594);
      }
      ...
      this.field2706 = class300_1.method5504((byte) 80) == 1;
      if (this.field2566 == 0) {
         this.field2687 = class300_1.method5496(-1459053594);
         this.field2569 = class300_1.method5496(-1459053594);
         this.field2580 = class300_1.method5504((byte) 101) == 1;
      }

      if (this.field2566 == 5) {
         this.field2599 = class300_1.method5499((byte) -48);
         this.field2591 = class300_1.method5496(-1459053594);
         this.field2613 = class300_1.method5504((byte) 70) == 1;
         this.field2595 = class300_1.method5504((byte) 125);
         this.field2559 = class300_1.method5504((byte) 89);
         this.field2604 = class300_1.method5499((byte) -62);
         this.field2605 = class300_1.method5504((byte) 85) == 1;
         this.field2606 = class300_1.method5504((byte) 72) == 1;
      }
      ...
      if (this.field2566 == 6) {
         ...
         this.field2593 = class300_1.method5606(-1327508233);
         this.field2614 = class300_1.method5606(-1327508233);
         this.field2615 = class300_1.method5496(-1459053594);
         this.field2616 = class300_1.method5496(-1459053594);
         this.field2640 = class300_1.method5496(-1459053594);
         this.field2618 = class300_1.method5496(-1459053594);
         this.field2611 = class300_1.method5496(-1459053594);
         if (this.field2611 == 65535) {
            this.field2611 = -1;
         ...
         this.field2621 = class300_1.method5504((byte) 8) == 1;
         class300_1.method5496(-1459053594);
         if (this.field2638 != 0) {
            this.field2619 = class300_1.method5496(-1459053594);
         }
      ...
      if (this.field2566 == 4) {
         ...
         this.field2601 = class300_1.method5503(-231155257);
         this.field2627 = class300_1.method5504((byte) 88);
         this.field2628 = class300_1.method5504((byte) 99);
         this.field2629 = class300_1.method5504((byte) 9);
         this.field2659 = class300_1.method5504((byte) 89) == 1;
         this.field2695 = class300_1.method5499((byte) -96);
      }

      if (this.field2566 == 3) {
         this.field2695 = class300_1.method5499((byte) -20);
         this.field2571 = class300_1.method5504((byte) 14) == 1;
         this.field2595 = class300_1.method5504((byte) 28);
      }

      if (this.field2566 == 9) {
         this.field2597 = class300_1.method5504((byte) 119);
         this.field2695 = class300_1.method5499((byte) -22);
         this.field2598 = class300_1.method5504((byte) 107) == 1;
      }

      this.field2669 = class300_1.method5567(1794705501);
      this.field2643 = class300_1.method5503(-231155257);
      int i_3 = class300_1.method5504((byte) 65);
      if (i_3 > 0) {
         this.field2644 = new String[i_3];

         for (int i_4 = 0; i_4 < i_3; i_4++) {
            this.field2644[i_4] = class300_1.method5503(-231155257);
         }
      }

      this.field2646 = class300_1.method5504((byte) 57);
      this.field2647 = class300_1.method5504((byte) 12);
      this.field2648 = class300_1.method5504((byte) 45) == 1;
      this.field2657 = class300_1.method5503(-231155257);
   ...
   public class211 method4040(boolean bool_1, byte b_2) {
      ...
      int i_3 = bool_1 ? this.field2600 : this.field2599;
      if (i_3 == -1) {
         return null;
      } else {
         ...
         if (class211_6 != null) {
            ...
            class325 class325_7 = this.method4036(bool_1, 424167363);
            if (class325_7 == null) {
               return null;
            } else {
               class325 class325_8 = class325_7.method6113();
               int[] ints_9 = new int[class325_8.field3900];
               int[] ints_10 = new int[class325_8.field3900];

               for (int i_11 = 0; i_11 < class325_8.field3900; i_11++) {
                  int i_12 = 0;
                  int i_13 = class325_8.field3899;

                  int i_14;
                  for (i_14 = 0; i_14 < class325_8.field3899; i_14++) {
                     if (class325_8.field3908[i_14 + i_11 * class325_8.field3899] == 0) {
                        i_12 = i_14;
                        break;
                     }
                  }

                  for (i_14 = class325_8.field3899 - 1; i_14 >= i_12; --i_14) {
                     if (class325_8.field3908[i_14 + i_11 * class325_8.field3899] == 0) {
                        i_13 = i_14 + 1;
                        break;
                     }
   ...
   public class325 method4038(int i_1, int i_2) {
      field2562 = false;
      if (i_1 >= 0 && i_1 < this.field2635.length) {
         int i_3 = this.field2635[i_1];
         if (i_3 == -1) {
            return null;
         } else {
   ...
   Object[] method4081(class300 class300_1, byte b_2) {
      int i_3 = class300_1.method5504((byte) 103);
      if (i_3 == 0) {
         return null;
      } else {
         ...
         for (int i_5 = 0; i_5 < i_3; i_5++) {
            int i_6 = class300_1.method5504((byte) 34);
            if (i_6 == 0) {
               arr_4[i_5] = new Integer(class300_1.method5499((byte) -109));
            } else if (i_6 == 1) {
               arr_4[i_5] = class300_1.method5503(-231155257);
            }
         }
   ...
   public void method4041(int i_1, String string_2, short s_3) {
      if (this.field2644 == null || this.field2644.length <= i_1) {
         ...
         if (this.field2644 != null) {
            for (int i_5 = 0; i_5 < this.field2644.length; i_5++) {
               arr_4[i_5] = this.field2644[i_5];
            }
         }

         this.field2644 = arr_4;
      }
   ...
   public void method4063(int i_1, int i_2, int i_3) {
      ...
      i_4 = this.field2705[i_2];
      this.field2705[i_2] = this.field2705[i_1];
   ...
   int[] method4034(class300 class300_1, byte b_2) {
      ...
      if (i_3 == 0) {
         ...
         for (int i_5 = 0; i_5 < i_3; i_5++) {
            ints_4[i_5] = class300_1.method5499((byte) -24);
         }
   ...
   static final void method4056(class66 class66_0, int i_1, int i_2, byte b_3, int i_4) {
      ...
      if (i_5 >= i_7 && i_5 < 104 - i_7 && i_6 >= i_7 && i_6 < 104 - i_7) {
         if (i_1 >= i_7 && i_1 < 104 - i_7 && i_2 >= i_7 && i_2 < 104 - i_7) {
            ...
            int i_14;
            int i_15;
            for (i_14 = 0; i_14 < 128; i_14++) {
               for (i_15 = 0; i_15 < 128; i_15++) {
                  class173.field2089[i_14][i_15] = 0;
                  class173.field2090[i_14][i_15] = 99999999;
               }
            }
            ...
            if (i_9 == 1) {
               ...
               i_20 = i_5 - b_18;
               i_21 = i_6 - b_19;
               class173.field2089[b_18][b_19] = 99;
               class173.field2090[b_18][b_19] = 0;
               b_22 = 0;
               i_23 = 0;
               ...
               while (true) {
                  ...
                  i_16 = class173.field2092[i_23];
                  i_17 = class173.field2094[i_23];
                  i_23 = i_23 + 1 & 0xfff;
                  i_36 = i_16 - i_20;
                  i_37 = i_17 - i_21;
                  ...
                  i_27 = class173.field2090[i_36][i_37] + 1;
                  if (i_36 > 0 && class173.field2089[i_36 - 1][i_37] == 0 && (ints_24[i_25 - 1][i_26] & 0x1240108) == 0) {
                     class173.field2092[i_39] = i_16 - 1;
                     class173.field2094[i_39] = i_17;
                     i_39 = i_39 + 1 & 0xfff;
                     class173.field2089[i_36 - 1][i_37] = 2;
                     class173.field2090[i_36 - 1][i_37] = i_27;
                  }

                  if (i_36 < 127 && class173.field2089[i_36 + 1][i_37] == 0 && (ints_24[i_25 + 1][i_26] & 0x1240180) == 0) {
                     class173.field2092[i_39] = i_16 + 1;
                     class173.field2094[i_39] = i_17;
                     i_39 = i_39 + 1 & 0xfff;
                     class173.field2089[i_36 + 1][i_37] = 8;
                     class173.field2090[i_36 + 1][i_37] = i_27;
                  }

                  if (i_37 > 0 && class173.field2089[i_36][i_37 - 1] == 0 && (ints_24[i_25][i_26 - 1] & 0x1240102) == 0) {
                     class173.field2092[i_39] = i_16;
                     class173.field2094[i_39] = i_17 - 1;
                     i_39 = i_39 + 1 & 0xfff;
                     class173.field2089[i_36][i_37 - 1] = 1;
                     class173.field2090[i_36][i_37 - 1] = i_27;
                  }

                  if (i_37 < 127 && class173.field2089[i_36][i_37 + 1] == 0 && (ints_24[i_25][i_26 + 1] & 0x1240120) == 0) {
                     class173.field2092[i_39] = i_16;
                     class173.field2094[i_39] = i_17 + 1;
                     i_39 = i_39 + 1 & 0xfff;
                     class173.field2089[i_36][i_37 + 1] = 4;
                     class173.field2090[i_36][i_37 + 1] = i_27;
                  }

                  if (i_36 > 0 && i_37 > 0 && class173.field2089[i_36 - 1][i_37 - 1] == 0 && (ints_24[i_25 - 1][i_26 - 1] & 0x124010e) == 0 && (ints_24[i_25 - 1][i_26] & 0x1240108) == 0 && (ints_24[i_25][i_26 - 1] & 0x1240102) == 0) {
                     class173.field2092[i_39] = i_16 - 1;
                     class173.field2094[i_39] = i_17 - 1;
                     i_39 = i_39 + 1 & 0xfff;
                     class173.field2089[i_36 - 1][i_37 - 1] = 3;
                     class173.field2090[i_36 - 1][i_37 - 1] = i_27;
                  }

                  if (i_36 < 127 && i_37 > 0 && class173.field2089[i_36 + 1][i_37 - 1] == 0 && (ints_24[i_25 + 1][i_26 - 1] & 0x1240183) == 0 && (ints_24[i_25 + 1][i_26] & 0x1240180) == 0 && (ints_24[i_25][i_26 - 1] & 0x1240102) == 0) {
                     class173.field2092[i_39] = i_16 + 1;
                     class173.field2094[i_39] = i_17 - 1;
                     i_39 = i_39 + 1 & 0xfff;
                     class173.field2089[i_36 + 1][i_37 - 1] = 9;
                     class173.field2090[i_36 + 1][i_37 - 1] = i_27;
                  }

                  if (i_36 > 0 && i_37 < 127 && class173.field2089[i_36 - 1][i_37 + 1] == 0 && (ints_24[i_25 - 1][i_26 + 1] & 0x1240138) == 0 && (ints_24[i_25 - 1][i_26] & 0x1240108) == 0 && (ints_24[i_25][i_26 + 1] & 0x1240120) == 0) {
                     class173.field2092[i_39] = i_16 - 1;
                     class173.field2094[i_39] = i_17 + 1;
                     i_39 = i_39 + 1 & 0xfff;
                     class173.field2089[i_36 - 1][i_37 + 1] = 6;
                     class173.field2090[i_36 - 1][i_37 + 1] = i_27;
                  }

                  if (i_36 < 127 && i_37 < 127 && class173.field2089[i_36 + 1][i_37 + 1] == 0 && (ints_24[i_25 + 1][i_26 + 1] & 0x12401e0) == 0 && (ints_24[i_25 + 1][i_26] & 0x1240180) == 0 && (ints_24[i_25][i_26 + 1] & 0x1240120) == 0) {
                     class173.field2092[i_39] = i_16 + 1;
                     class173.field2094[i_39] = i_17 + 1;
                     i_39 = i_39 + 1 & 0xfff;
                     class173.field2089[i_36 + 1][i_37 + 1] = 12;
                     class173.field2090[i_36 + 1][i_37 + 1] = i_27;
                  }
               }
               ...
               while (true) {
                  ...
                  while (true) {
                     do {
                        do {
                           do {
                              ...
                              do {
                                 ...
                                 i_27 = class173.field2090[i_36][i_37] + 1;
                                 if (i_36 > 0 && class173.field2089[i_36 - 1][i_37] == 0 && (ints_24[i_25 - 1][i_26] & 0x124010e) == 0 && (ints_24[i_25 - 1][i_9 + i_26 - 1] & 0x1240138) == 0) {
                                    i_28 = 1;
                                    ...
                                    while (true) {
                                       ...
                                       if ((ints_24[i_25 - 1][i_28 + i_26] & 0x124013e) != 0) {
                                          break;
                                       }
                                 ...
                                 if (i_36 < 128 - i_9 && class173.field2089[i_36 + 1][i_37] == 0 && (ints_24[i_25 + i_9][i_26] & 0x1240183) == 0 && (ints_24[i_25 + i_9][i_26 + i_9 - 1] & 0x12401e0) == 0) {
                                    i_28 = 1;
                                    ...
                                    while (true) {
                                       ...
                                       if ((ints_24[i_9 + i_25][i_28 + i_26] & 0x12401e3) != 0) {
                                          break;
                                       }
                                 ...
                                 if (i_37 > 0 && class173.field2089[i_36][i_37 - 1] == 0 && (ints_24[i_25][i_26 - 1] & 0x124010e) == 0 && (ints_24[i_25 + i_9 - 1][i_26 - 1] & 0x1240183) == 0) {
                                    i_28 = 1;
                                    ...
                                    while (true) {
                                       ...
                                       if ((ints_24[i_28 + i_25][i_26 - 1] & 0x124018f) != 0) {
                                          break;
                                       }
                                 ...
                                 if (i_37 < 128 - i_9 && class173.field2089[i_36][i_37 + 1] == 0 && (ints_24[i_25][i_9 + i_26] & 0x1240138) == 0 && (ints_24[i_9 + i_25 - 1][i_9 + i_26] & 0x12401e0) == 0) {
                                    i_28 = 1;
                                    ...
                                    while (true) {
                                       ...
                                       if ((ints_24[i_28 + i_25][i_9 + i_26] & 0x12401f8) != 0) {
                                          break;
                                       }
                                 ...
                                 if (i_36 > 0 && i_37 > 0 && class173.field2089[i_36 - 1][i_37 - 1] == 0 && (ints_24[i_25 - 1][i_26 - 1] & 0x124010e) == 0) {
                                    i_28 = 1;
                                    ...
                                    while (true) {
                                       ...
                                       if ((ints_24[i_25 - 1][i_28 + (i_26 - 1)] & 0x124013e) != 0 || (ints_24[i_28 + (i_25 - 1)][i_26 - 1] & 0x124018f) != 0) {
                                          break;
                                       }
                                 ...
                                 if (i_36 < 128 - i_9 && i_37 > 0 && class173.field2089[i_36 + 1][i_37 - 1] == 0 && (ints_24[i_25 + i_9][i_26 - 1] & 0x1240183) == 0) {
                                    i_28 = 1;
                                    ...
                                    while (true) {
                                       ...
                                       if ((ints_24[i_9 + i_25][i_28 + (i_26 - 1)] & 0x12401e3) != 0 || (ints_24[i_25 + i_28][i_26 - 1] & 0x124018f) != 0) {
                                          break;
                                       }
                                 ...
                                 if (i_36 > 0 && i_37 < 128 - i_9 && class173.field2089[i_36 - 1][i_37 + 1] == 0 && (ints_24[i_25 - 1][i_9 + i_26] & 0x1240138) == 0) {
                                    for (i_28 = 1; i_28 < i_9; i_28++) {
                                       if ((ints_24[i_25 - 1][i_26 + i_28] & 0x124013e) != 0 || (ints_24[i_28 + (i_25 - 1)][i_26 + i_9] & 0x12401f8) != 0) {
                                          continue label615;
                                       }
                                    }
                        ...
                        } while (class173.field2089[i_36 + 1][i_37 + 1] != 0);
                     } while ((ints_24[i_25 + i_9][i_26 + i_9] & 0x12401e0) != 0);

                     for (i_28 = 1; i_28 < i_9; i_28++) {
                        if ((ints_24[i_25 + i_28][i_9 + i_26] & 0x12401f8) != 0 || (ints_24[i_9 + i_25][i_28 + i_26] & 0x12401e3) != 0) {
                           continue label638;
                        }
                     }
            ...
            label696: {
               i_15 = i_5 - 64;
               i_16 = i_6 - 64;
               i_17 = class173.field2088;
               i_36 = class218.field2707;
               if (!bool_34) {
                  ...
                  for (i_26 = i_39 - b_38; i_26 <= b_38 + i_39; i_26++) {
                     for (i_27 = i_23 - b_38; i_27 <= b_38 + i_23; i_27++) {
                        i_28 = i_26 - i_15;
                        int i_29 = i_27 - i_16;
                        if (i_28 >= 0 && i_29 >= 0 && i_28 < 128 && i_29 < 128 && class173.field2090[i_28][i_29] < 100) {
                           int i_30 = 0;
                           if (i_26 < i_39) {
                              i_30 = i_39 - i_26;
                           } else if (i_26 > i_39 + i_33 - 1) {
                              i_30 = i_26 - (i_33 + i_39 - 1);
                           }

                           int i_31 = 0;
                           if (i_27 < i_23) {
                              i_31 = i_23 - i_27;
                           } else if (i_27 > i_25 + i_23 - 1) {
                              i_31 = i_27 - (i_25 + i_23 - 1);
                           }

                           int i_32 = i_30 * i_30 + i_31 * i_31;
                           if (i_32 < i_37 || i_32 == i_37 && class173.field2090[i_28][i_29] < i_20) {
                              i_37 = i_32;
                              i_20 = class173.field2090[i_28][i_29];
                              i_17 = i_26;
                              i_36 = i_27;
                           }
                        }
                  ...
                  if (i_37 == Integer.MAX_VALUE) {
                     i_8 = -1;
                     break label696;
                  }
               }

               if (i_5 == i_17 && i_6 == i_36) {
                  i_8 = 0;
               } else {
                  b_19 = 0;
                  class173.field2092[b_19] = i_17;
                  i_37 = b_19 + 1;
                  class173.field2094[b_19] = i_36;

                  for (i_20 = i_21 = class173.field2089[i_17 - i_15][i_36 - i_16]; i_17 != i_5 || i_6 != i_36; i_20 = class173.field2089[i_17 - i_15][i_36 - i_16]) {
                     if (i_20 != i_21) {
                        i_21 = i_20;
                        class173.field2092[i_37] = i_17;
                        class173.field2094[i_37++] = i_36;
                     }
                  ...
                  while (i_37-- > 0) {
                     ints_12[i_39] = class173.field2092[i_37];
                     ints_13[i_39++] = class173.field2094[i_37];
                     if (i_39 >= ints_12.length) {
                        break;
                     }
                  }
   ...
   public static String method4092(byte[] bytes_0, int i_1, int i_2, int i_3) {
      ...
      for (int i_5 = i_1; i_5 < i_2 + i_1; i_5 += 3) {
         ...
         stringbuilder_4.append(class290.field3673[i_6 >>> 2]);
         if (i_5 < i_2 - 1) {
            int i_7 = bytes_0[i_5 + 1] & 0xff;
            stringbuilder_4.append(class290.field3673[(i_6 & 0x3) << 4 | i_7 >>> 4]);
            if (i_5 < i_2 - 2) {
               int i_8 = bytes_0[i_5 + 2] & 0xff;
               stringbuilder_4.append(class290.field3673[(i_7 & 0xf) << 2 | i_8 >>> 6]).append(class290.field3673[i_8 & 0x3f]);
            } else {
               stringbuilder_4.append(class290.field3673[(i_7 & 0xf) << 2]).append("=");
            }
         } else {
            stringbuilder_4.append(class290.field3673[(i_6 & 0x3) << 4]).append("==");
         }
      }
