   ...
   public void method5075(ByteBuffer class300_1, int i_2, int i_3) {
      while (true) {
         if (class300_1.position < i_2) {
            ...
            Username username_6 = new Username(class300_1.readNullTerminatedString(), this.field3618);
            Username username_7 = new Username(class300_1.readNullTerminatedString(), this.field3618);
            class300_1.readNullTerminatedString();
            if (username_6 != null && username_6.method5205()) {
               class278 class278_8 = (class278) this.method5138(username_6);
               if (bool_5) {
                  class278 class278_9 = (class278) this.method5138(username_7);
               ...
               if (class278_8 != null) {
                  this.method5083(class278_8, username_6, username_7);
                  continue;
               }

               if (this.method5079() < 400) {
                  int i_10 = this.method5079();
                  class278_8 = (class278) this.method5088(username_6, username_7);
