public class class246 extends DualNode {
   ...
   void method4464(ByteBuffer class300_1, int i_2, byte b_3) {
      if (i_2 == 1) {
         class300_1.readUnsignedShort();
      } else if (i_2 == 2) {
         this.field3275 = class300_1.readUnsignedByte();
      } else if (i_2 == 3) {
         this.field3282 = class300_1.readUnsignedByte();
      } else if (i_2 == 4) {
         this.field3283 = 0;
      } else if (i_2 == 5) {
         this.field3285 = class300_1.readUnsignedShort();
      } else if (i_2 == 6) {
         class300_1.readUnsignedByte();
      } else if (i_2 == 7) {
         this.field3286 = class300_1.readNullableShort();
      } else if (i_2 == 8) {
         this.field3287 = class300_1.readNullableShort();
      } else if (i_2 == 11) {
         this.field3283 = class300_1.readUnsignedShort();
      } else if (i_2 == 14) {
         this.field3288 = class300_1.readUnsignedByte();
      } else if (i_2 == 15) {
         this.field3289 = class300_1.readUnsignedByte();
      }

   }

   void method4473(ByteBuffer class300_1, byte b_2) {
      while (true) {
   ...
   public class325 method4466(int i_1) {
      if (this.field3287 < 0) {
         ...
         class325 class325_2 = (class325) field3276.get((long)this.field3287);
         if (class325_2 != null) {
            return class325_2;
         } else {
   ...
   public class325 method4465(byte b_1) {
      if (this.field3286 < 0) {
         ...
         class325 class325_2 = (class325) field3276.get((long)this.field3286);
         if (class325_2 != null) {
            return class325_2;
         } else {
