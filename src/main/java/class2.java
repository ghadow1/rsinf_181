   ...
   static final void method26(Widget[] arr_0, int i_1, int i_2, int i_3, int i_4, int i_5, int i_6, int i_7) {
      for (int i_9 = 0; i_9 < arr_0.length; i_9++) {
         ...
         if (widget_10 != null && widget_10.field2583 == i_1 && (!widget_10.field2563 || widget_10.field2566 == 0 || widget_10.field2551 || class268.method4987(widget_10) != 0 || widget_10 == Client.field829 || widget_10.field2568 == 1338)) {
            ...
            int i_11 = widget_10.field2577 + i_6;
            int i_12 = i_7 + widget_10.field2699;
            int i_13;
            int i_14;
            int i_15;
            int i_16;
            ...
            if (widget_10.field2566 == 2) {
               ...
               int i_17;
               if (widget_10.field2566 == 9) {
                  i_17 = i_11;
                  i_18 = i_12;
                  i_19 = i_11 + widget_10.field2579;
                  int i_20 = i_12 + widget_10.field2667;
                  if (i_19 < i_11) {
                     i_17 = i_19;
                     i_19 = i_11;
                  }
                  ...
                  i_17 = i_11 + widget_10.field2579;
                  i_18 = i_12 + widget_10.field2667;
            ...
            if (widget_10.field2704) {
               ...
               default:
                  break;
               case 2:
                  if (Client.field818 == widget_10.field2688 >>> 16) {
                     bool_33 = true;
                  }
                  break;
               case 3:
                  if (widget_10.field2688 == Client.field818) {
                     bool_33 = true;
                  }
               }
            }
            ...
            if (bool_33 || !widget_10.field2563 || i_13 < i_15 && i_14 < i_16) {
               if (widget_10.field2563) {
                  ...
                  if (widget_10.field2580) {
                     if (MouseHandler.MouseHandler_x >= i_13 && MouseHandler.MouseHandler_y >= i_14 && MouseHandler.MouseHandler_x < i_15 && MouseHandler.MouseHandler_y < i_16) {
                        ...
                        if (WorldMapElement.field1143 == 0) {
               ...
               i_18 = MouseHandler.MouseHandler_x;
               i_19 = MouseHandler.MouseHandler_y;
               if (MouseHandler.field493 != 0) {
                  i_18 = MouseHandler.field483;
                  i_19 = MouseHandler.field495;
               }
               ...
               if (widget_10.field2568 == 1337) {
                  ...
                  if (!Client.field674 && bool_34) {
                     if (widget_10.field2568 == 1400) {
                        class136.field1875.method6482(i_11, i_12, widget_10.field2579, widget_10.field2667, i_18, i_19, 90618974);
                     } else {
                        FontName.method703(widget_10, i_18 - i_11, i_19 - i_12, -641953545);
                     }
                  }
                  ...
                  int i_24;
                  if (bool_33) {
                     for (int i_21 = 0; i_21 < widget_10.field2650.length; i_21++) {
                        bool_22 = false;
                        boolean bool_23 = false;
                        if (!bool_22 && widget_10.field2650[i_21] != null) {
                           for (i_24 = 0; i_24 < widget_10.field2650[i_21].length; i_24++) {
                              boolean bool_25 = false;
                              if (widget_10.field2578 != null) {
                              ...
                              if (PacketWriter.method2244(widget_10.field2650[i_21][i_24]) || bool_25) {
                                 ...
                                 byte b_26 = widget_10.field2625[i_21][i_24];
                        ...
                        if (bool_23) {
                           if (i_21 < 10) {
                              ...
                              Client.selectedSpellName = widget_10.field2643 + class73.colorStartTag(16777215);
                           }

                           i_24 = widget_10.field2641[i_21];
                           if (widget_10.field2578 == null) {
                              widget_10.field2578 = new int[widget_10.field2650.length];
                           }

                           if (widget_10.field2588 == null) {
                              widget_10.field2588 = new int[widget_10.field2650.length];
                           }
                        ...
                        if (!bool_22 && widget_10.field2578 != null) {
                           widget_10.field2578[i_21] = 0;
                        }
                     }
                  }
                  ...
                  if (widget_10.field2563) {
                     ...
                     if ((MouseHandler.field485 == 1 || !class46.field413 && MouseHandler.field485 == 4) && bool_34) {
                        bool_35 = true;
                     }

                     bool_22 = false;
                     if ((MouseHandler.field493 == 1 || !class46.field413 && MouseHandler.field493 == 4) && MouseHandler.field483 >= i_13 && MouseHandler.field495 >= i_14 && MouseHandler.field483 < i_15 && MouseHandler.field495 < i_16) {
                        bool_22 = true;
                     }

                     if (bool_22) {
                        class60.method1118(widget_10, MouseHandler.field483 - i_11, MouseHandler.field495 - i_12, 1446112965);
                     }
                     ...
                     if (widget_10.field2551) {
                        ...
                        if (widget_10.field2626 != null && Client.field806 > widget_10.field2592) {
                           if (widget_10.field2664 != null && Client.field806 - widget_10.field2592 <= 32) {
                              label865:
                              for (i_36 = widget_10.field2592; i_36 < Client.field806; i_36++) {
                        ...
                        if (widget_10.field2665 != null && Client.field671 > widget_10.field2603) {
                           if (widget_10.field2666 != null && Client.field671 - widget_10.field2603 <= 32) {
                              label841:
                              for (i_36 = widget_10.field2603; i_36 < Client.field671; i_36++) {
                        ...
                        if (widget_10.field2594 != null && Client.field846 > widget_10.field2700) {
                           if (widget_10.field2668 != null && Client.field846 - widget_10.field2700 <= 32) {
                              label817:
                              for (i_36 = widget_10.field2700; i_36 < Client.field846; i_36++) {
                  ...
                  if (!widget_10.field2563) {
                     ...
                     if ((widget_10.field2685 >= 0 || widget_10.field2587 != 0) && MouseHandler.MouseHandler_x >= i_13 && MouseHandler.MouseHandler_y >= i_14 && MouseHandler.MouseHandler_x < i_15 && MouseHandler.MouseHandler_y < i_16) {
                        if (widget_10.field2685 >= 0) {
                           class72.field1059 = arr_0[widget_10.field2685];
                        } else {
                           class72.field1059 = widget_10;
                        }
                     }

                     if (widget_10.field2566 == 8 && MouseHandler.MouseHandler_x >= i_13 && MouseHandler.MouseHandler_y >= i_14 && MouseHandler.MouseHandler_x < i_15 && MouseHandler.MouseHandler_y < i_16) {
                        class32.field284 = widget_10;
                     }

                     if (widget_10.field2569 > widget_10.field2667) {
                        class6.method71(widget_10, i_11 + widget_10.field2579, i_12, widget_10.field2667, widget_10.field2569, MouseHandler.MouseHandler_x, MouseHandler.MouseHandler_y, -2024126373);
                     }
                  }
