public class class253 extends DualNode {
      ...
      if (i_2 == 1) {
         ...
         if (i_4 > 0) {
            if (this.field3362 != null && !field3352) {
               class300_1.position += 3 * i_4;
            } else {
               this.field3359 = new int[i_4];
               this.field3362 = new int[i_4];

               for (i_5 = 0; i_5 < i_4; i_5++) {
                  this.field3362[i_5] = class300_1.readUnsignedShort();
                  this.field3359[i_5] = class300_1.readUnsignedByte();
               }
            }
         }
      } else if (i_2 == 2) {
         this.field3360 = class300_1.readNullTerminatedString();
      } else if (i_2 == 5) {
         i_4 = class300_1.readUnsignedByte();
         if (i_4 > 0) {
            if (this.field3362 != null && !field3352) {
               class300_1.position += i_4 * 2;
            } else {
               this.field3359 = null;
               this.field3362 = new int[i_4];
         ...
         this.field3365 = class300_1.readUnsignedByte();
      } else if (i_2 == 15) {
         this.field3366 = class300_1.readUnsignedByte();
      } else if (i_2 == 17) {
         this.field3382 = 0;
         ...
         this.field3369 = class300_1.readUnsignedByte();
      } else if (i_2 == 21) {
         this.field3370 = 0;
      } else if (i_2 == 22) {
         this.field3371 = true;
         ...
         this.field3373 = class300_1.readUnsignedShort();
         ...
         this.field3374 = class300_1.readUnsignedByte();
      } else if (i_2 == 29) {
         this.field3350 = class300_1.readSignedByte();
      } else if (i_2 == 39) {
         this.field3380 = class300_1.readSignedByte() * 25;
      } else if (i_2 >= 30 && i_2 < 35) {
         this.field3377[i_2 - 30] = class300_1.readNullTerminatedString();
         ...
         for (i_5 = 0; i_5 < i_4; i_5++) {
            this.field3375[i_5] = (short)class300_1.readUnsignedShort();
            this.field3353[i_5] = (short)class300_1.readUnsignedShort();
         }
      } else if (i_2 == 41) {
         i_4 = class300_1.readUnsignedByte();
         ...
         for (i_5 = 0; i_5 < i_4; i_5++) {
            this.field3363[i_5] = (short)class300_1.readUnsignedShort();
            this.field3364[i_5] = (short)class300_1.readUnsignedShort();
         }
      } else if (i_2 == 62) {
         this.field3358 = true;
      } else if (i_2 == 64) {
         ...
         this.field3381 = class300_1.readUnsignedShort();
      } else if (i_2 == 66) {
         this.field3383 = class300_1.readUnsignedShort();
      } else if (i_2 == 67) {
         this.field3384 = class300_1.readUnsignedShort();
      } else if (i_2 == 68) {
         this.field3379 = class300_1.readUnsignedShort();
      } else if (i_2 == 69) {
         class300_1.readUnsignedByte();
      } else if (i_2 == 70) {
         this.field3385 = class300_1.readSignedShortBigEndian();
      } else if (i_2 == 71) {
         this.field3386 = class300_1.readSignedShortBigEndian();
      } else if (i_2 == 72) {
         this.field3376 = class300_1.readSignedShortBigEndian();
      } else if (i_2 == 73) {
         this.field3388 = true;
      } else if (i_2 == 74) {
         this.field3389 = true;
      } else if (i_2 == 75) {
         this.field3361 = class300_1.readUnsignedByte();
      } else if (i_2 != 77 && i_2 != 92) {
         if (i_2 == 78) {
            this.field3394 = class300_1.readUnsignedShort();
            this.field3399 = class300_1.readUnsignedByte();
         } else if (i_2 == 79) {
            this.field3392 = class300_1.readUnsignedShort();
            this.field3397 = class300_1.readUnsignedShort();
            this.field3399 = class300_1.readUnsignedByte();
            i_4 = class300_1.readUnsignedByte();
            this.field3367 = new int[i_4];

            for (i_5 = 0; i_5 < i_4; i_5++) {
               this.field3367[i_5] = class300_1.readUnsignedShort();
            }
         } else if (i_2 == 81) {
            this.field3370 = class300_1.readUnsignedByte() * 256;
         } else if (i_2 == 82) {
         ...
         this.field3393 = class300_1.readUnsignedShort();
         ...
         for (int i_6 = 0; i_6 <= i_5; i_6++) {
            this.field3391[i_6] = class300_1.readUnsignedShort();
   ...
   final Model method4594(int i_1, int i_2) {
      ...
      if (this.field3359 == null) {
         ...
         for (int i_7 = 0; i_7 < i_6; i_7++) {
            ...
            model_4 = (Model) field3387.get((long)i_8);
            if (model_4 == null) {
               ...
               field3387.put(model_4, (long)i_8);
            }
         ...
         model_4 = (Model) field3387.get((long)i_6);
         if (model_4 == null) {
            ...
            field3387.put(model_4, (long)i_6);
         }
      }

      if (this.field3381 == 128 && this.field3383 == 128 && this.field3384 == 128) {
         bool_5 = false;
      } else {
         bool_5 = true;
      }
      ...
      boolean bool_12;
      if (this.field3385 == 0 && this.field3386 == 0 && this.field3376 == 0) {
         bool_12 = false;
      } else {
         bool_12 = true;
      }
   ...
   void method4625(ByteBuffer class300_1) {
      while (true) {
         ...
         this.method4628(class300_1, i_3);
      }
   }
   ...
   public final class127 method4614(int i_1, int i_2, int[][] ints_3, int i_4, int i_5, int i_6, class258 class258_7, int i_8) {
      ...
      if (this.field3359 == null) {
         ...
         long_10 = (long)(i_2 + (i_1 << 3) + (this.field3357 << 10));
      }

      class127 class127_12 = (class127) field3355.get(long_10);
      if (class127_12 == null) {
   ...
   public final class127 method4592(int i_1, int i_2, int[][] ints_3, int i_4, int i_5, int i_6) {
      ...
      class127 class127_10 = (class127) field3355.get(long_8);
      if (class127_10 == null) {
         ...
         field3355.put(class127_10, long_8);
      }
   ...
   public final Entity method4591(int i_1, int i_2, int[][] ints_3, int i_4, int i_5, int i_6, byte b_7) {
      ...
      if (obj_10 == null) {
         ...
         field3354.put((DualNode) obj_10, long_8);
      }
