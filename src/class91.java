...
public class class91 {
   ...
   static final void writeSomePacket(int i_0, int i_1, int i_2, int i_3, String string_5, int i_6, int i_7) {
      if (i_2 >= 2000) {
         i_2 -= 2000;
      }
                           ...
                           label926: {
                              if (i_2 != 57) {
                                 ...
                                 if (i_2 == 1003) {
                                    ...
                                    NPC_14 = Client.npcs[i_3];
                                    if (NPC_14 != null) {
                                       NPCDefinition NPCDefinition_18 = NPC_14.definition;
                                       if (NPCDefinition_18.field3476 != null) {
                                          NPCDefinition_18 = NPCDefinition_18.transform();
                                       }
