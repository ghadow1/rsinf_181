      ...
      if (class85.field1205) {
         ...
         if (Client.field662 == 20) {
            ...
            if (class85.field1209 != 4) {
               ...
               s_25 = 200;
               string_6 = class17.field117.field1066 ? ClientPacketProt.method3612(class85.field1180) : class85.field1180;
               ...
               i_24 += 15;
               class295_0.method5346("Password: " + ClientPacketProt.method3612(class85.field1198), class85.field1187 + 180 - 108, i_24, 16777215, 0);
               i_24 += 15;
            }
         }
         ...
         if (Client.field662 == 10 || Client.field662 == 11) {
            ...
            if (class85.field1209 == 0) {
               ...
               if (class85.field1209 == 2) {
                  ...
                  i_24 += 15;
                  class295_0.method5346("Password: " + ClientPacketProt.method3612(class85.field1198) + (class85.field1202 == 1 & Client.field881 % 40 < 20 ? class73.method1756(16776960, -844505624) + "|" : ""), class62.field585 - 108, i_24, 16777215, 0);
                  i_24 += 15;
                  s_23 = 277;
                  ...
                  if (class85.field1209 == 4) {
                     ...
                     class295_0.method5341(class85.field1196, class85.field1187 + 180, i_24, 16777215, 0);
                     i_24 += 15;
                     class295_0.method5346("PIN: " + ClientPacketProt.method3612(class36.field328) + (Client.field881 % 40 < 20 ? class73.method1756(16776960, -844505624) + "|" : ""), class85.field1187 + 180 - 108, i_24, 16777215, 0);
                     i_24 -= 8;
         ...
         if (Client.field662 > 5 && class56.field528 == class190.field2348) {
            if (class30.field264 != null) {
               ...
               class30.field264 = class215.method4021(Client.field683, "sl_button", "");
            }
         }
