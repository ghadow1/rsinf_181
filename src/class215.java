public class class215 {
      ...
      if (long_0 > 0L && long_0 < 6582952005840035281L) {
         if (long_0 % 37L == 0L) {
            ...
            for (stringbuilder_5 = new StringBuilder(i_2); long_0 != 0L; stringbuilder_5.append(var_8)) {
               long long_6 = long_0;
               long_0 /= 37L;
               var_8 = class289.field3668[(int)(long_6 - long_0 * 37L)];
               if (var_8 == 95) {
   ...
   public static class324 method4021(class233 class233_0, String string_1, String string_2, int i_3) {
      int i_4 = class233_0.method4160(string_1, 2045003287);
      int i_5 = class233_0.method4161(i_4, string_2, (byte) 70);
      return class299.method5474(class233_0, i_4, i_5, -1232611828);
   }
