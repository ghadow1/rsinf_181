public class GameState implements UnknownT {

   static String field3095;
   static final GameState field3087 = new GameState(0, -1, true, false, true);
   static final GameState field3084 = new GameState(1, 0, true, true, true);
   static final GameState field3085 = new GameState(2, 1, true, true, false);
   static final GameState field3093 = new GameState(3, 2, false, false, true);
