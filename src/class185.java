public class class185 {
   ...
   static void method3617(byte[] bytes_0, byte b_1) {
      ...
      class326.field3911 = class300_2.readShortUBigEndian();
      ...
      for (i_4 = 0; i_4 < class326.field3911; i_4++) {
         class212.field2523[i_4] = class300_2.readShortUBigEndian();
      }

      for (i_4 = 0; i_4 < class326.field3911; i_4++) {
         class326.field3915[i_4] = class300_2.readShortUBigEndian();
      }

      for (i_4 = 0; i_4 < class326.field3911; i_4++) {
         class326.field3914[i_4] = class300_2.readShortUBigEndian();
      }

      for (i_4 = 0; i_4 < class326.field3911; i_4++) {
         class216.field2548[i_4] = class300_2.readShortUBigEndian();
      }
